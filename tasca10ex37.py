...
el joc consisteix en crear un codi de 4 xifres i demanar a 
l’usuari que vagi introduint codis de 4 xifres fins que l’endevini. En cada jugada, 
li direm quants número ha encertat (estan en la posició correcte) i quants coincideixen 
